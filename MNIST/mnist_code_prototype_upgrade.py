...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if filter_button == True: 
            update_epoch_accuracy_matrix_dataset1(test_acc, current_epoch_accuracy_detail_lst, train_dataset, trainset_permutation_inds, args)
...
if __name__ == "__main__":
    ...
    '''
    parser.add_argument("--filtered_index_file_path", type=str, default="C:\\Users\\GM\\Desktop\\liuzhengchang\\CODE\\filtered_index_file_path_mnist_10.pt", help="filtered_index_file_path")
    parser.add_argument("--sorting_file", type=str, default="C:\\Users\\GM\\Desktop\\liuzhengchang\\CODE\\mnist_results\\mnist_sorted.pkl", help="sorting_file")

    args = parser.parse_args()
    main(args)

# filter:
# python mnist_code_prototype_upgrade.py --epochs 200 --batch_size 64 --lr 0.01 --seed 1 --th_win 3 --th_stable_acc 0.001 --th_stable_loss 0.001 --th_train_acc 0.85 --filter_button --threshold_occupation 2 --start_new_dataloader_min_nums 100 --threshold_test_accuracy_to_build_new_data 0.6  --min_data_nums_per_class 10 --max_data_nums_per_class 600 --run_mode filter --filtered_index_file_path C:\\Users\\GM\\Desktop\\liuzhengchang\\CODE\\filtered_index_file_path_mnist_10.pt --sorting_file C:\\Users\\GM\\Desktop\\liuzhengchang\\CODE\\mnist_results\\mnist_sorted.pkl